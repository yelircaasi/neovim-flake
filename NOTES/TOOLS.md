No — `propagatedBuildInputs` is still about *linkable* things (headers, libs) re-exported to consumers. LSPs are **runtime** dependencies, which is a different category.
